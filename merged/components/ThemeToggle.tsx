...
const ORDER: ThemePref[] = ['system', 'light', 'dark', 'neon'];
const LABEL: Record<ThemePref, string> = { system: 'System', light: 'Light', dark: 'Dark', neon: 'Neon blue' };

/** One button that cycles System → Light → Dark → Neon blue. The choice is remembered. */
  ...
  return (
    ...
    >
      <svg width="15" height="15" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.4" aria-hidden="true">
        ...
        {pref === 'neon' && (<><path d="M9 1.5L3.5 9h4l-1 5.5L12.5 7h-4z" /><circle cx="8" cy="8" r="7" opacity=".35" /></>)}
      </svg>
    </button>
  );
}
