...
const ROWS: [string, string][] = [
  ...
  ['A', 'Archive'],
  ['T', 'Timeline'],
  ['M', 'World progress: the map of major inventions'],
  ['/', 'Search your discoveries'],
  ['Enter', 'Use the discovery just found'],
  ['Esc', 'Close a panel · dismiss an ending · let go of a craft · skip every globe reveal waiting'],
  ['Drag', 'Move, throw and drop things on the bench'],
  ['Space', 'The main action while crafting: hold, strike, press · skips a globe reveal'],
